...
export default function TherapistPage() {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        const res = await axios.get("https://sih-prototype-zkpp.onrender.com/api/me", { withCredentials: true });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://sih-prototype-zkpp.onrender.com/api/appointment",
        { therapist: selectedTherapist, ...formData },
        { withCredentials: true }
      );
      if (res.data.success) {
        const updated = await axios.get("https://sih-prototype-zkpp.onrender.com/api/me", { withCredentials: true });
  ...
  const handleCancel = async (appointmentId) => {
    try {
      const res = await axios.put(
        `https://sih-prototype-zkpp.onrender.com/api/appointment/${appointmentId}/cancel`,
        {},
        { withCredentials: true }
      );
      if (res.data.success) {
  ...
  const handleReschedule = async (appointmentId) => {
    ...
    try {
      const res = await axios.put(
        `https://sih-prototype-zkpp.onrender.com/api/appointment/${appointmentId}/reschedule`,
        { date: newDate },
        { withCredentials: true }
      );
      if (res.data.success) {
